      ...
      {!isSubmitted && (
        <div className="wrapper">
          ...
          <p className="text-gray-400 mb-10">
            Please let us know ho we did with your support request. All feedback
...
const ThankYou = ({ items, setIsSubmitted }) => {
  return (
    <div className="wrapper">
      <img src={thanks} className="block mx-auto mb-5" />
      <div className="flex items-center justify-center">
        <p className="p-rating bg-gray-700 rounded-full text-center text-sm px-2 pt-1">
